...
cpl_custom_theme <- function(base_size = 12,
    ...
    ggplot2::theme(
        ...
        axis.title.y = ggplot2::element_text(angle = 0L,
                                             margin = ggplot2::margin(r = 4L)),
        axis.title.x.top = NULL,
        axis.title.y.right = NULL,
        axis.ticks = ggplot2::element_line(colour = "#b2bbcb"),
        axis.ticks.length = ggplot2::unit(4L, "pt"),
        axis.ticks.x = ggplot2::element_line(colour = NULL,
                                             size = NULL,
                                             linetype = NULL,
                                             lineend = NULL),
        axis.ticks.y = ggplot2::element_line(colour = NULL, # adding back Y axis ticks
                                             size = NULL,
                                             linetype = NULL,
                                             lineend = NULL),
        axis.line = ggplot2::element_line(colour = "#b2bbcb"),
        axis.line.x = ggplot2::element_line(colour = NULL,
                                            size = NULL,
                                            linetype = NULL,
                                            lineend = NULL),
        axis.line.y = ggplot2::element_line(colour = NULL, # adding back Y axis line
                                            size = NULL,
                                            linetype = NULL,
                                            lineend = NULL),
        ...
        panel.grid.major.y = ggplot2::element_line(colour = "#b2bbcb",
                                                   size = base_line_size/2L,
                                                   linetype = "dashed"), # set y grids
        ...
        strip.background = ggplot2::element_rect(fill = "#b2bbcb",
                                                 colour = NA,
                                                 size = 10L),
